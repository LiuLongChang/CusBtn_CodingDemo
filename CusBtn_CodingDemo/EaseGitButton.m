...
-(instancetype)initWithFrame:(CGRect)frame normalTitle:(NSString*)normalTitle checkedTitle:(NSString*)checkedTitle normalIcon:(NSString*)normalIcon checkedIcon:(NSString*)checkedIcon normalBGColor:(UIColor*)normalBGColor checkedBGColor:(UIColor*)checkedBGColor normalBorderColor:(UIColor*)normalBorderColor checkedBorderColor:(UIColor*)checkedBorderColor userNum:(NSInteger)userNum checked:(BOOL)checked{
...
+(instancetype)gitButtonWithFrame:(CGRect)frame normalTitle:(NSString*)normalTitle checkedTitle:(NSString*)checkedTitle normalIcon:(NSString*)normalIcon checkedIcon:(NSString*)checkedIcon normalBGColor:(UIColor*)normalBGColor checkedBGColor:(UIColor*)checkedBGColor normalBorderColor:(UIColor*)normalBorderColor checkedBorderColor:(UIColor*)checkedBorderColor userNum:(NSInteger)userNum checked:(BOOL)checked{
...
-(void)updateContent{
    ...
    [_rightButton setTitle:[NSString stringWithFormat:@"%ld",_userNum] forState:UIControlStateNormal];
}
